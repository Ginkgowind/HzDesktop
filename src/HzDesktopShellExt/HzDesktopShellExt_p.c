...
typedef struct _HzDesktopShellExt_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } HzDesktopShellExt_MIDL_TYPE_FORMAT_STRING;

typedef struct _HzDesktopShellExt_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } HzDesktopShellExt_MIDL_PROC_FORMAT_STRING;

typedef struct _HzDesktopShellExt_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } HzDesktopShellExt_MIDL_EXPR_FORMAT_STRING;
...
extern const HzDesktopShellExt_MIDL_TYPE_FORMAT_STRING HzDesktopShellExt__MIDL_TypeFormatString;
extern const HzDesktopShellExt_MIDL_PROC_FORMAT_STRING HzDesktopShellExt__MIDL_ProcFormatString;
extern const HzDesktopShellExt_MIDL_EXPR_FORMAT_STRING HzDesktopShellExt__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IHzDesktopMenuExt_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IHzDesktopMenuExt_ProxyInfo;
...
static const HzDesktopShellExt_MIDL_PROC_FORMAT_STRING HzDesktopShellExt__MIDL_ProcFormatString =
    {
        0,
        {
...
static const HzDesktopShellExt_MIDL_TYPE_FORMAT_STRING HzDesktopShellExt__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IHzDesktopMenuExt, ver. 0.0,
   GUID={0xff7c8c69,0x789b,0x4985,{0xac,0x8a,0x75,0x59,0xd7,0x79,0x45,0xca}} */

#pragma code_seg(".orpc")
static const unsigned short IHzDesktopMenuExt_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SYNTAX_INFO IComponentRegistrar_SyntaxInfo [  2 ] = 
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    HzDesktopShellExt__MIDL_ProcFormatString.Format,
    &IComponentRegistrar_FormatStringOffsetTable[-3],
    HzDesktopShellExt__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    }
...
#pragma code_seg(".orpc")
static const FormatInfoRef IHzDesktopMenuExt_Ndr64ProcTable[] =
    {
    (FormatInfoRef)(LONG_PTR) -1,
    (FormatInfoRef)(LONG_PTR) -1,
    (FormatInfoRef)(LONG_PTR) -1,
...
static const MIDL_SYNTAX_INFO IHzDesktopMenuExt_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    HzDesktopShellExt__MIDL_ProcFormatString.Format,
    &IHzDesktopMenuExt_FormatStringOffsetTable[-3],
    HzDesktopShellExt__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    ...
    0,
    0 ,
    (unsigned short *) &IHzDesktopMenuExt_Ndr64ProcTable[-3],
    0,
    NDR64_UserMarshalRoutines,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IHzDesktopMenuExt_ProxyInfo =
    {
    &Object_StubDesc,
    HzDesktopShellExt__MIDL_ProcFormatString.Format,
    &IHzDesktopMenuExt_FormatStringOffsetTable[-3],
    (RPC_SYNTAX_IDENTIFIER*)&_RpcTransferSyntax_2_0,
    2,
    (MIDL_SYNTAX_INFO*)IHzDesktopMenuExt_SyntaxInfo
    
    };


static const MIDL_SERVER_INFO IHzDesktopMenuExt_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    HzDesktopShellExt__MIDL_ProcFormatString.Format,
    (unsigned short *) &IHzDesktopMenuExt_FormatStringOffsetTable[-3],
    0,
    (RPC_SYNTAX_IDENTIFIER*)&_NDR64_RpcTransferSyntax_1_0,
    2,
    (MIDL_SYNTAX_INFO*)IHzDesktopMenuExt_SyntaxInfo
    };
CINTERFACE_PROXY_VTABLE(7) _IHzDesktopMenuExtProxyVtbl = 
{
    0,
    &IID_IHzDesktopMenuExt,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    0 /* IDispatch::GetTypeInfoCount */ ,
...
EXTERN_C DECLSPEC_SELECTANY const PRPC_STUB_FUNCTION IHzDesktopMenuExt_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IHzDesktopMenuExtStubVtbl =
{
    &IID_IHzDesktopMenuExt,
    &IHzDesktopMenuExt_ServerInfo,
    7,
    &IHzDesktopMenuExt_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
const CInterfaceProxyVtbl * const _HzDesktopShellExt_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IHzDesktopMenuExtProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _HzDesktopShellExt_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IHzDesktopMenuExtStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _HzDesktopShellExt_InterfaceNamesList[] = 
{
    "IHzDesktopMenuExt",
    "IComponentRegistrar",
    0
...
const IID *  const _HzDesktopShellExt_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _HzDesktopShellExt_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _HzDesktopShellExt, pIID, n)

int __stdcall _HzDesktopShellExt_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _HzDesktopShellExt, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _HzDesktopShellExt, 2, *pIndex )
    
}

EXTERN_C const ExtendedProxyFileInfo HzDesktopShellExt_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _HzDesktopShellExt_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _HzDesktopShellExt_StubVtblList,
    (const PCInterfaceName * ) & _HzDesktopShellExt_InterfaceNamesList,
    (const IID ** ) & _HzDesktopShellExt_BaseIIDList,
    & _HzDesktopShellExt_IID_Lookup, 
    2,
    2,
